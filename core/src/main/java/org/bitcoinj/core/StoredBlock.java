...
public class StoredBlock {
    ...
    public static final int COMPACT_SERIALIZED_SIZE = Block.DEFAULT_HEADER_SIZE + CHAIN_WORK_BYTES + 4;  // for height
    ...
    public void serializeCompact(ByteBuffer buffer) {
        ...
        buffer.put(bytes, 0, Block.DEFAULT_HEADER_SIZE);  // Trim the trailing 00 byte (zero transactions).
    }
    ...
    public static StoredBlock deserializeCompact(NetworkParameters params, ByteBuffer buffer) throws ProtocolException {
        ...
        byte[] header = new byte[Block.DEFAULT_HEADER_SIZE + 1];    // Extra byte for the 00 transactions length.
        buffer.get(header, 0, Block.DEFAULT_HEADER_SIZE);
